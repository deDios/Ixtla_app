                ...
                <aside class="kb-details" id="kb-details" aria-label="Detalle de la asignación" aria-hidden="true">
                    ...
                    <div class="kb-d-body" id="kb-d-body" hidden>
                        ...
                        <div class="kb-d-section">
                            ...
                            <!-- Botón Generar expediente (arriba del Folio, alineado a la derecha) -->
                            <div class="kb-d-section-head">
                                <button type="button" class="exp-expediente-btn" id="kb-btn-expediente">
                                    <svg class="exp-expediente-icon" viewBox="0 0 24 24" aria-hidden="true">
                                        ...
                                        <path d="M8 15h5" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" />
                                        <path d="M9 18h6a.6.6 0 0 0 .6-.6v-1.8A.6.6 0 0 0 15 15h-6v3z"
...
<script type="module">
    ...
    <script type="module" src="/JS/expedienteTareas.js"></script>
