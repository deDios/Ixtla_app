  ...
  <div class="hs-wrap">
    ...
    <aside class="hs-sidebar">
      ...
      <nav class="hs-states" aria-label="Estados">
        <button class="item is-active"><span class="label">Todos</span><span class="count">(50)</span></button>
    ...
    <section class="hs-main exp-view">
      ...
      <header class="exp-head">
        <div class="exp-title"><h1>Fuga de agua</h1></div>
        <dl class="exp-meta">
          <div><dt>Informante</dt><dd>Luis Enrique Mendez</dd></div>
          <div><dt>Encargado</dt><dd>Juan Pablo</dd></div>
          <div><dt>Fecha de solicitado</dt><dd>04/06/2025 12:30pm</dd></div>
        </dl>
      </header>
      ...
      <section class="exp-pane is-active" role="tabpanel" data-tab="informante">
        <div class="exp-grid">
          <div class="exp-field"><label>Nombre:</label><div class="exp-val">Luis Enrique Mendez</div></div>
          <div class="exp-field"><label>Teléfono:</label><div class="exp-val">33 3333 3333</div></div>
          <div class="exp-field"><label>Dirección del reporte:</label><div class="exp-val">Vicente Guerrero #13, Centro</div></div>
          <div class="exp-field"><label>Correo:</label><div class="exp-val"><a href="mailto:correo@ejemplo.com">correo@ejemplo.com</a></div></div>
          <div class="exp-field"><label>C.P.:</label><div class="exp-val">45850</div></div>
        </div>
      </section>
      ...
      <section class="exp-pane" role="tabpanel" data-tab="detalles">
        <div class="exp-grid">
          <div class="exp-field"><label>Nombre del Requerimiento:</label><div class="exp-val">Fuga de agua</div></div>
          <div class="exp-field"><label>Líder del Departamento:</label><div class="exp-val"><a href="#">Juan Pablo</a></div></div>
          <div class="exp-field"><label>Asignado:</label><div class="exp-val"><a href="#">Luis Enrique Mendez</a></div></div>
          <div class="exp-field"><label>Estatus:</label><div class="exp-val"><span class="exp-badge is-info">En proceso</span></div></div>
          <div class="exp-field exp-field--full">
            <label>Descripción:</label>
            <div class="exp-val exp-preline">
              Vimos una fuga de agua en una casa amarilla de dos pisos, lleva más de 3 horas tirando agua y no parece que se encuentren los propietarios. Nos preocupa porque es agua limpia.
            </div>
          </div>
          <div class="exp-field"><label>Fecha de inicio:</label><div class="exp-val">02/09/2025</div></div>
          <div class="exp-field"><label>Fecha de terminado:</label><div class="exp-val">—</div></div>
        </div>
      </section>
