...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const DEPS = {
    ...
    "2": { name: "Recolección y limpieza", inactive: false },
    "3": { name: "Obras y servicios públicos", inactive: false },
    "4": { name: "Alumbrado y energía urbana", inactive: false },
    "5": { name: "Gestión ambiental y ecología", inactive: false },
  };
