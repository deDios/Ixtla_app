...
<body class="ixtla-dashboard-page">
  <header class="ixtla-dashboard-top">
    ...
    <div class="ixtla-dashboard-actions"><a class="ixtla-dashboard-button ixtla-dashboard-button--ghost" href="/VIEWS/UAT/home.php">Abrir Home</a><button class="ixtla-dashboard-button" id="ixtla-dashboard-clear" type="button">Cerrar dashboard</button></div>
  </header>
