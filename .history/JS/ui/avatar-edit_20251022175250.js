...
// Módulo para insertar el botón flotante de "editar avatar" sobre una imagen.
// Usa openEditorDeAvatar() si existe. Si no, hace fallback a input file + POST.

export function setupAvatarEditButton({
  imgSelector = "#hs-avatar",
  endpoint = "/db/WEB/ixtla01_u_usuario_avatar.php", // tu endpoint PHP
  session = (window.Session?.get?.() || null),       // opcional: sesión para cache-bust
} = {}) {
