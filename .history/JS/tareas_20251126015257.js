...
// ENDPOINT DE COMENTARIOS (Nuevo endpoint agregado)
const API_COMENTARIOS = {
  // DB\WEB\ixtla01_c_comentario_requerimiento.php
  LIST: `${API_FBK.HOST}/db/WEB/ixtla01_c_comentario_requerimiento.php`,
  // INSER: `${API_FBK.HOST}/db/WEB/ixtla01_in_comentario_requerimiento.php`,
};
...
async function init() {
  ...
  DetailsModule = createTaskDetailsModule({
    ...
    postJSON,
    Session, 
    API_COMENTARIOS, // <--- CAMBIO: Se pasa la API de Comentarios
  });
