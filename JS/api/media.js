...
// === URLs ===
const URL_SETUP  = "https://ixtlahuacan-fvasgmddcxd3gbc3.mexicocentral-01.azurewebsites.net/db/WEB/ixtla01_u_requerimiento_folders.php"; // el que crea 0..6 y regresa urls
const URL_LIST   = "https://ixtlahuacan-fvasgmddcxd3gbc3.mexicocentral-01.azurewebsites.net/db/WEB/ixtla01_c_requerimiento_img.php";     // listado (el que acabamos de definir)
const URL_UPLOAD = "https://ixtlahuacan-fvasgmddcxd3gbc3.mexicocentral-01.azurewebsites.net/db/WEB/ixtla01_i_requerimiento_img.php";     // tu endpoint de subida (el que mandaste)
