...
(function () {
  ...
  const SCORE_BY_STATUS = { 0: 0, 1: 0, 2: 0.5, 3: 0.8, 4: 1.0, 5: 1.0 };
  function taskPct(t) {
  ...
  function addTareaRow(sec, t) {
    ...
    const STATUS_TEXT = {
      ...
      3: "Por revisar",
      4: "Hecho",
      5: "Bloqueada", // ⬅ texto para status bloqueado
    };
    const s = Number(t.status ?? 0);
    ...
    const pct = taskPct(t);
    const progressExtraClass = s === 5 ? " warning" : ""; // ⬅ clase extra para la barra
