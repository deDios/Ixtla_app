...
$ts     = (string) time();
$method = 'POST';
$path   = '/db/WEB/ixtla01_in_requerimiento.php'; // ← Debe coincidir exactamente
...
echo $resp !== false ? $resp : json_encode(['ok'=>false,'error'=>'Proxy: fallo al contactar API','detail'=>$err]);
