...
// Params: event_12 requiere EXACTAMENTE 1 parametro
$folio = "";
...
if (!is_array($params)) {
  ...
  if (count($params) !== 1) {
    $errors[] = "event_12 requiere exactamente 1 param: [folio].";
  } else {
 ...
 * El boton en Meta ya tiene la base:
 * https://ixtla-app.com/VIEWS/retroCiudadana.php?folio=
 * Solo mandamos el folio como valor dinamico
 * ========================= */
$buttonParams = [
  [
    "type" => "text",
