...
const URL_SETUP  = "https://TU_HOST/db/WEB/ixtla01_setup_requerimiento_media.php"; // el que crea 0..6 y regresa urls
const URL_LIST   = "https://TU_HOST/db/WEB/ixtla01_c_requerimiento_media.php";     // listado (el que acabamos de definir)
const URL_UPLOAD = "https://TU_HOST/db/WEB/ixtla01_i_requerimiento_media.php";     // tu endpoint de subida (el que mandaste)
