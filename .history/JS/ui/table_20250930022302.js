...
export function createTable({
  ...
  function render() {
    ...
    if (pag) {
      ...
      pag.innerHTML = html;
      pag.querySelectorAll("button").forEach(b => b.addEventListener("click", () => setPage(parseInt(b.dataset.p, 10))));
    }
    paintSortIndicators();
  }
  ...
  initHeader();
  return { setData, setPage, setSort, getSort, setPageSize, destroy };
}
