            ...
            <section class="hs-main">
                ...
                <div class="kb-wrap">
                    <div class="kb-board" id="kb-board">
                        ...
                        <!-- Columna: Por hacer (estatus 0: Solicitud, 2: Asignación opcionalmente caerán aquí) -->
                        ...
                        <!-- Columna: Por revisar (estatus 1: Revisión) -->
                        ...
                        <!-- Columna: Hecho (estatus 6: Finalizado) -->
                        ...
                        <!-- Panel de detalles -->
                        <aside class="kb-details" id="kb-details" aria-live="polite" aria-atomic="true">
                            <div class="kb-d-empty">Selecciona una tarjeta para ver detalles</div>
                            <div class="kb-d-body" hidden>
                                <div class="kb-d-head">
                                    <div class="kb-d-title" id="kb-d-title">—</div>
                                    <div class="kb-d-folio" id="kb-d-folio">—</div>
                                </div>
                                <div class="kb-d-meta">
                                    <div><strong>Asignado:</strong> <span id="kb-d-asignado">—</span></div>
                                    <div><strong>Departamento:</strong> <span id="kb-d-depto">—</span></div>
                                    <div><strong>Contacto:</strong> <span id="kb-d-contacto">—</span></div>
                                    <div><strong>Tel:</strong> <span id="kb-d-tel">—</span></div>
                                    <div><strong>Creado:</strong> <span id="kb-d-creado">—</span></div>
                                    <div><strong>Estatus:</strong> <span id="kb-d-status">—</span></div>
                                </div>
                                <div class="kb-d-desc" id="kb-d-desc">—</div>
                            </div>
                        </aside>
