...
expect($catalog['version'] === 2, 'El contrato debe tener versión explícita.');
...
expect(ixtla_insights_catalog_contains('report_intents', 'comparison'), 'comparison debe ser una intención de reporte permitida.');
