...
<head>
    ...
    <link rel="stylesheet" href="/CSS/components.css?v=geo-canal1-1">
...
<body>
    ...
    <script src="/JS/ui/geolocationMap.js?v=geo-canal1-1"></script>
    <script src="/JS/tramiteDepartamentos.js?v=geo-canal1-1"></script>
