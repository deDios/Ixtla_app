...
<body class="ix-sidebar-sticky"><!-- ← NUEVO: habilita sticky del sidebar -->
    ...
    <div class="ix-wrap">
      <div class="home-grid">
        ...
        <aside class="home-sidebar">
          <div class="sidebar-scroll"><!-- ← NUEVO wrapper para sticky + scroll -->
          ...
          <section class="table-card" aria-labelledby="tbl-title">
            <div class="table-head">
              ...
              <div class="table-tools">
                <div class="input-search has-icon"><!-- ← NUEVO .has-icon -->
                  <input id="tbl-search" type="search"
  ...
  <section aria-label="Panel de trámite">
    <aside class="ix-drawer" role="dialog" aria-modal="true" aria-labelledby="ix-drw-title" data-drawer="panel">
      ...
      <div class="ixd-body">
        ...
        <!-- Prioridad / Canal (no cambio de orden) -->
        <div class="ixd-grid2">
          <div class="ixd-field">
