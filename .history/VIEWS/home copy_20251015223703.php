          ...
          <div class="hs-head">
            ...
            <div class="hs-tools">
              <div class="search" role="search">
                ...
                <input id="hs-search" type="search" placeholder="Buscar por folio, ID (#123) o status…" aria-label="Buscar">
              </div>
              <div class="legend">
      ...
      <div class="footer-cols">
        <div class="col left">
          <div class="left-inner">
            ...
            <p class="copyright">
              © Presidente José Heriberto García Murillo Gobierno de Ixtlahuacán de los Membrillos 2021 | Todos los derechos reservados.
            </p>
          </div>
        </div>
        <div class="col right">
