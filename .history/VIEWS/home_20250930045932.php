...
<body>
    ...
    <section aria-label="Panel de trámite">
        <aside class="ix-drawer" role="dialog" aria-modal="true" aria-labelledby="ix-drw-title" data-drawer="panel">
            ...
            <!-- Header compacto (solo folio + cerrar) -->
            ...
            <div class="ixd-body">
                ...
                <!-- Imagen principal + lápiz (solo visible en modo edición) -->
    ...
    <script type="module">
    /* Drawer overlay para edición + evidencias por estatus */
    (function() {
        ...
        function setEditing(on) {
            ...
            // el lápiz solo visible en edición (CSS ya lo maneja)
        }
        ...
        async function listMedia({
            ...
            // Endpoint de listado (el que usarás en backend):
            ...
            try {
                ...
                return res.items || res.saved || []; // tolerante al shape
            } catch (e) {
    ...
    <script type="module" src="/JS/views/home.js"></script>
