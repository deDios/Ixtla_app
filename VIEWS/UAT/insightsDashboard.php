...
<head>
  ...
  <link rel="stylesheet" href="/CSS/UAT/ixtla-insights-dashboard.css?v=dashboard-refresh-1">
</head>
<body class="ixtla-dashboard-page">
  ...
  <script type="module" src="/JS/UAT/insights/dashboard.js?v=dashboard-refresh-1"></script>
</body>
</html>
