            ...
            <section class="hs-main exp-view">
                ...
                <div class="exp-panes">
                    ...
                    <section class="exp-pane" role="tabpanel" data-tab="planeacion">
                        ...
                        <!-- Toolbar superior (fuera de los acordeones) -->
                        <div class="planeacion-toolbar" role="toolbar" aria-label="Planeación">
                        ...
                        <section class="exp-accordion exp-accordion--fase">
                            <button class="exp-acc-head" type="button" aria-expanded="true">
                                <!-- Importante: chevron primero para cuadrar el grid -->
                                ...
                                <div class="fase-right">
                                    ...
                                    <span class="exp-progress" aria-label="70%">
                                        <span class="bar" style="width:70%"></span><span class="pct">70%</span>
                                    </span>
                        ...
                        <section class="exp-accordion exp-accordion--fase">
                            <button class="exp-acc-head" type="button" aria-expanded="true">
                                ...
                                <div class="fase-head">
                                    ...
                                    <small class="fase-meta">8 actividades</small>
                                </div>
                                ...
                                <div class="fase-right">
                                    ...
                                    <span class="fase-label">Estatus</span>
                                    <span class="exp-progress" aria-label="45%">
                                        <span class="bar" style="width:45%"></span><span class="pct">45%</span>
                                    </span>
                                    <span class="fase-label">Fecha de inicio</span>
                                    <span class="fase-date">15/06/2025</span>
                                </div>
                            </button>
                            ...
                            <div class="exp-acc-body">
                                <div class="exp-table exp-table--planeacion is-card">
                                    ...
                                    <div class="exp-row">
                                        <div class="actividad">Inspección de zona</div>
                                        <div class="responsable">Juan Pablo</div>
                                        <div class="estatus"><span class="exp-badge is-info">Activo</span></div>
                                        <div class="porcentaje"><span class="exp-progress xs"><span class="bar"
                                                    style="width:45%"></span></span></div>
