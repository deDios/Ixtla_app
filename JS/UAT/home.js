...
import { mountIxtlaInsights } from "/JS/UAT/insights/chat.js?v=assistant-behavior-1";
...
const INSIGHTS_CONFIG = {
  ...
  frontendBuild: "assistant-behavior-1",
  simpleMode: true,
  quickQuestions: [
    {
...
/* ======================================================================
   Auto-refresh decoraciones (chevrons / filas expandibles) cuando la tabla
...
function setupAutoRefreshTableDecorations() {
  ...
  if (thead) thead.addEventListener("click", kick);

  // Extra: si cambia el breakpoint, repinta expander/header
