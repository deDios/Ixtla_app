...
if ($path && file_exists($path)) { include $path; } else {
  http_response_code(500); die(json_encode(["ok"=>false,"error"=>"No se encontró conn_db.php"]));
}
...
echo json_encode(["ok" => true, "promedio_semanal" => $promedio_semanal, "tiempo_resolucion" => $tiempo_resolucion]);
$con->close();
?>