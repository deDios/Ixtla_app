...
<body>
    ...
    <!-- Drawer -->
    <aside class="ix-drawer open" role="dialog" aria-modal="true" aria-labelledby="ix-drw-title" data-drawer="panel">
        <header class="ix-drawer__header">
            <div class="left">
                <h3 id="ix-drw-title">
                    <span class="ix-drw-folio">REQ-0000000078</span>
                    <span class="badge-status" data-k="solicitud">Solicitud</span>
                </h3>
                <div class="mini-meta">
                    <div><strong>Trámite:</strong> <span data-field="tramite_nombre">Fuga de agua</span></div>
                    <div><strong>Depto:</strong> <span data-field="departamento_nombre">SAMAPA</span></div>
                    <div><strong>Asignado a:</strong> <span data-field="asignado_nombre_completo">Pablo Agustín de Dios
                            García</span></div>
                    <div><strong>Creado:</strong> <span data-field="created_at">2025-09-26 11:28:15</span></div>
                </div>
            </div>
            <div class="right">
                <label class="status-select">
                    <span>Estatus:</span>
                    <select data-drawer="statusSelect" aria-label="Cambiar estatus">
        ...
        <div class="ix-drawer__content">
            ...
            <section class="drw-pane is-active" data-pane="detalle">
                <div class="field"><label>Asunto</label>
                    <p data-field="asunto">Reporte Fuga de agua</p>
                </div>
                <div class="field"><label>Descripción</label>
                    <p data-field="descripcion">este mensaje es un ejemplo para seguir validando el funcionamiento</p>
                </div>

                <div class="grid-2">
                    <div class="field"><label>Prioridad</label>
                        <p data-field="prioridad">2</p>
                    </div>
                    <div class="field"><label>Canal</label>
                        <p data-field="canal">1</p>
                    </div>
                </div>
                ...
                <div class="grid-2">
                    <div class="field"><label>Nombre</label>
                        <p data-field="contacto_nombre">Luis Enrique Mendez Fernandez</p>
                    </div>
                    <div class="field"><label>Teléfono</label>
                        <p data-field="contacto_telefono">3313812235</p>
                    </div>
                </div>
                <div class="grid-2">
                    <div class="field"><label>Email</label>
                        <p data-field="contacto_email">kakike9@gmail.com</p>
                    </div>
                    <div class="field"><label>Código Postal</label>
                        <p data-field="contacto_cp">44580</p>
                    </div>
                </div>
                <div class="field"><label>Calle</label>
                    <p data-field="contacto_calle">Vicente guerrero #13</p>
                </div>
                <div class="field"><label>Colonia</label>
                    <p data-field="contacto_colonia">Centro Histórico</p>
                </div>
            </section>
            ...
            <section class="drw-pane" data-pane="imagenes">
                ...
                <div class="img-grid" data-img="grid">
                    <div class="img-card">
                        ...
                        <img src="https://ixtlahuacan-fvasgmddcxd3gbc3.mexicocentral-01.azurewebsites.net/ASSETS/requerimientos/REQ-0000000078/0/credit-card_10335812_20250926112816_2be360c0.png"
                            loading="lazy" alt="credit-card_10335812_20250926112816_2be360c0.png">
                        <div class="img-name" title="credit-card_10335812_20250926112816_2be360c0.png">
                            credit-card_10335812_20250926112816_2be360c0.png</div>
                    </div>
                </div>
