...
// Board dataset: tarea_proceso + proceso_requerimiento + requerimiento + depto + tramite (+ empleados)
// Devuelve tareas con contexto para evitar N+1 en frontend.
...
$baseSelect = "
  SELECT SQL_CALC_FOUND_ROWS
    ...
    -- Proceso (si quieres mostrarlo en UI)
